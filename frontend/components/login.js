...
const Login = () =>{
    ...
    const iniciarSesion = () => {
        ...
        // console.log(data)
        fetch('http://localhost:5000/users/signin', {method: 'POST', cache: 'no-cache', headers: {"Content-Type": "application/json"}, body: JSON.stringify(data)}).then(data => data.json()).then(data => {
            // console.log(data)
    ...
    const registrarse = () => {
        ...
        fetch('http://localhost:5000/users/signup', {method: 'POST', headers: {"Content-Type": "application/json"}, body: JSON.stringify(datosRegistro)})
        fetch('http://localhost:5000/users/signin', {method: 'POST', headers: {"Content-Type": "application/json"}, body: JSON.stringify(datosInicio)}).then(datos => datos.json()).then(datos => {
            // console.log(datos)
